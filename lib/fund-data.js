...
export function buildCorrelationMatrix(funds, rangeKey = "1Y") {
  ...
  return {
    ...
    note:
      `La matriz usa correlacion de Pearson sobre los rendimientos entre fechas compartidas dentro del rango ${periodLabel}, anclado a la ultima fecha comun disponible. Cada pareja de fondos requiere al menos ${MIN_CORRELATION_INTERVALS} intervalos compartidos; si no, se muestra N/D.`,
  };
}
