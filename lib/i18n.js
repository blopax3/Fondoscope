const LANGUAGE_CONFIG = {
  es: {
    ...
    dashboard: {
      ...
      loadSectionDescription: "Busca fondos, acciones y ETF por nombre.",
      searchLabel: "Buscar activos",
      searchPlaceholder: "Ej.: Azvalor, Apple, Vanguard",
      searching: "Buscando…",
      noSearchResults: "No se encontraron activos.",
      searchError: "No se pudo completar la búsqueda.",
      sourceLabel: "Fuente",
      removeTitle: "Eliminar",
      selectedFundsHint: (count) =>
        `${count} activo${count > 1 ? "s" : ""} seleccionado${count > 1 ? "s" : ""} · Máximo 8`,
      emptyHint: "Escribe al menos dos caracteres y selecciona un resultado.",
  ...
  en: {
    ...
    dashboard: {
      ...
      loadSectionDescription: "Search funds, stocks, and ETFs by name.",
      searchLabel: "Search assets",
      searchPlaceholder: "E.g. Azvalor, Apple, Vanguard",
      searching: "Searching…",
      ...
      removeTitle: "Remove",
      selectedFundsHint: (count) =>
        `${count} asset${count > 1 ? "s" : ""} selected · Maximum 8`,
      emptyHint: "Enter at least two characters and select a result.",
