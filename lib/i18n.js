const LANGUAGE_CONFIG = {
  es: {
    ...
    dashboard: {
      ...
      loadSectionDescription: "Introduce uno o varios ISIN y ajusta la divisa antes de lanzar la consulta.",
      ...
      portfolioSectionDescription: "Guarda combinaciones frecuentes y recárgalas sin volver a introducir los ISIN.",
  ...
  en: {
    ...
    dashboard: {
      ...
      loadSectionDescription: "Enter one or more ISINs and adjust the currency before loading the data.",
      ...
      portfolioSectionDescription: "Store frequent combinations and load them again without re-entering the ISINs.",
